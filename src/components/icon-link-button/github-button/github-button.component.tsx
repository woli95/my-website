import { useGithubButton } from "./github-button.hook";
import { IconLinkButtonProps } from "../icon-link-button.types";

export const GithubButton = (props: Omit<IconLinkButtonProps, "variant">) => {
  const {
    handleOnClick,
    handleOnMouseEnter,
    handleOnMouseLeave,
  ...
  return (
    ...
    >
      <g fill="none" fillRule="evenodd" stroke="none" strokeWidth="1">
        <g ref={pathRef} fill="#888888" transform="translate(-140 -7559)">
